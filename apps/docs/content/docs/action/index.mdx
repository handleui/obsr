---
title: GitHub Action
description: Collect errors and enable AI resolving in your workflows
---

The Detent action runs at the end of your CI job to collect structured error data and send it for AI-powered resolving.

## What It Does

- **Detects Errors** — Finds JSON outputs from ESLint, Vitest, golangci-lint, Cargo
- **Extracts Context** — Reads source code around each error for AI context
- **Reports to API** — Sends structured data (not logs) to Detent backend
- **Enables Resolving** — Powers automatic fix suggestions and PR comments
...
<Tabs items={["ESLint", "Vitest", "golangci-lint", "Cargo"]}>
  <Tab value="ESLint">
...
| `codeSnippet` | 7 lines | Context for AI resolving |
