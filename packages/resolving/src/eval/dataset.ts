 ...
 */
export const RESOLVING_DATASET: ResolvingTestCase[] = [
  {
 ...
 */
export const getTestCasesByTag = (tag: string): ResolvingTestCase[] =>
  RESOLVING_DATASET.filter((tc) => tc.tags?.includes(tag));

/**
 * Get a single test case by ID.
 */
export const getTestCaseById = (id: string): ResolvingTestCase | undefined =>
  RESOLVING_DATASET.find((tc) => tc.id === id);
