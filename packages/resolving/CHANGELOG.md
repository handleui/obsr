...
- c16d1b6: Add structured error reporting to resolving loop with error classification and context tracking.
...
- a5bac3a: Initial release of the Detent resolving module (AI-powered error correction)
