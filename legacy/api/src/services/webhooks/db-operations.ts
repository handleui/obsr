...
export const ciErrorToRow = (
  ...
  const compactDiagnostic: ResolverDiagnostic = {
    message:
    ...
    category: truncateString(
      error.category,
      100
    ) as ResolverDiagnostic["category"],
    severity: (truncateString(error.severity, 50) ??
      "error") as ResolverDiagnostic["severity"],
  ...
  return {
    ...
    filePath: compactDiagnostic.filePath,
    line: compactDiagnostic.line,
    column: compactDiagnostic.column,
    category: compactDiagnostic.category,
    severity: compactDiagnostic.severity,
    ruleId: compactDiagnostic.ruleId,
    ...
    fixable: compactDiagnostic.fixable,
    logLineStart,
    logLineEnd,
