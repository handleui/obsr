 ...
 *
 * These scorers use the default resolving model for consistency with production behavior.
 * Each scorer evaluates a different aspect of the resolving quality.
 *
