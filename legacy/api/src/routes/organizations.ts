...
app.get("/:organizationId/status", githubOrgAccessMiddleware, async (c) => {
  ...
  return c.json({
    ...
    settings: {
      ...
      resolve_auto_trigger: settings.resolveAutoTrigger,
...
app.patch(
  ...
  async (c) => {
    ...
    if ("resolve_auto_trigger" in providedSettings) {
      newSettings.resolveAutoTrigger = providedSettings.resolve_auto_trigger;
    }
    ...
    return c.json({
      ...
      settings: {
        ...
        resolve_auto_trigger: finalSettings.resolveAutoTrigger,
