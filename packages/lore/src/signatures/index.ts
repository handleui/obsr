...
import type { FingerprintableDiagnostic } from "../types.js";
...
export const generateFingerprints = (
  error: FingerprintableDiagnostic
): ErrorFingerprints => {
...
export const generateSignature = (error: FingerprintableDiagnostic): string => {
