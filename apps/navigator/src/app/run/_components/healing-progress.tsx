  ...
  <div className="flex h-full w-full flex-col bg-white">
    <div className="flex flex-1 items-center justify-center p-8">
      <div className="flex flex-col items-center gap-4 text-center">
        <div className="flex size-12 items-center justify-center bg-healing-bg">
          <Sparks className="size-5" color="var(--color-healing-fg)" />
        </div>
...
const CompactHealingProgress = () => (
  <div className="sticky top-0 z-10 flex h-10 items-center gap-2 border-subtle border-b bg-white px-4">
    <Sparks className="size-4" color="var(--color-healing-fg)" />
    <ShimmerText
      animation="animate-shimmer-sweep-fast"
      className="text-[13px]"
      color="var(--color-healing-fg)"
