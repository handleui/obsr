...
Any language with tooling that outputs structured errors. TypeScript, JavaScript, Go, Rust, and Python work best. See [Supported Tools](/docs/cli/tools).
...
Make sure your tools output JSON. Detent can't parse raw console output. See [Supported Tools](/docs/cli/tools) for setup instructions.
